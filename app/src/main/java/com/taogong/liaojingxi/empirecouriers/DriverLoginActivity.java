    ...
    private BarcodeCallback callback = new BarcodeCallback() {
        ...
        public void barcodeResult(BarcodeResult result) {
            if (result.getText() != null) {
                ...
                String script = "var inputEle = document.getElementsByTagName('input')[0];inputEle.value = '" + lastText + "';var event1 = document.createEvent('HTMLEvents');  event1.initEvent('change', true, true); event1.eventType = 'change'; inputEle.dispatchEvent(event1); document.getElementsByTagName('input')[0].blur();";
